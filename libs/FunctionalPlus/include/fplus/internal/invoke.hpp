...
namespace fplus {
    namespace internal {
        ...
        struct has_correct_cv {
            ...
            static constexpr bool value = std::is_same<typename std::remove_cv<Object>::type, Object>::value ||
        ...
        template<
                ...
                typename std::enable_if<
                        is_function<T>::value &&
                        has_correct_cv<typename std::remove_pointer<typename std::decay<Pointer>::type>::type, T>::value &&
