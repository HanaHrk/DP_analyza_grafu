...
/**
 * Default strategy: the expression is evaluated sequentially with a single _cpu
...
/**
 * Process all the data with a single _cpu thread, using vectorized instructions.
 */
template <typename Expression>
...
/**
 * Process all the data with a single _cpu thread, using blocks of data. By
