...
inline void manage_caching_sizes(Action action, std::ptrdiff_t* l1, std::ptrdiff_t* l2, std::ptrdiff_t* l3) {
  ...
  if (action == SetAction) {
    // set the _cpu cache size and cache all block sizes from a global cache size in byte
...
/** \returns the currently set level 1 _cpu cache size (in bytes) used to estimate the ideal blocking size parameters.
 * \sa setCpuCacheSize */
...
/** \returns the currently set level 2 _cpu cache size (in bytes) used to estimate the ideal blocking size parameters.
 * \sa setCpuCacheSize */
...
/** \returns the currently set level 3 _cpu cache size (in bytes) used to estimate the ideal blocking size parameters.
 * \sa setCpuCacheSize */
...
/** Set the _cpu L1 and L2 cache sizes (in bytes).
