...
if TEST_OUTPUT_DIR[-1] != "/":
    TEST_OUTPUT_DIR = TEST_OUTPUT_DIR+"/"
if not os.path.exists(TEST_OUTPUT_DIR):
    os.makedirs(TEST_OUTPUT_DIR)

if len(sys.argv) == 4:
    # if threshold is included as an argument
...
def main():
    ...
    save_test_predictions_as_imgs(test_loader, model, image_height = IMAGE_HEIGHT, image_width = IMAGE_WIDTH, padding = PADDING, output_dir=TEST_OUTPUT_DIR, device=DEVICE, threshold=THRESHOLD)
